...
def show_images():
    ...
    plt.title('dirty')
    plt.show(block=False)
    while(plt.fignum_exists(1) and plt.fignum_exists(2) and plt.fignum_exists(3)):
        try:
            plt.pause(10000000)
            plt.close("all")
        except:
...
def main():
    ...
    list_total = []
    list_load = []
    "n = 0 ==> image taille 2048 x 2048"
    "n = 1 ==> image taille 4096 x 4096"
    "n = 2 ==> image taille 8192 x 8192"
    "n = 3 ==> image taille 16384 x 16384"
    n = 1
